...
from app.api.routes import ai, brand_intel, brands, contracts, dashboard, franchise_agent, knowledge, merchants, reports, risk, spider
...
app = FastAPI(
    ...
    description="Single-Agent franchise risk analysis API powered by LangChain, DeepSeek and Chroma RAG.",
    version="0.6.0",
    lifespan=lifespan,
)
...
app.include_router(franchise_agent.router, prefix="/api/franchise-agent", tags=["single-franchise-agent"])
...
def read_root() -> dict[str, str]:
    return {
        ...
        "positioning": "茶饮咖啡加盟风险智能分析",
        "llm": settings.deepseek_model,
        "docs": "/docs",
        "new_api": "/api/franchise-agent/analyze",
    }
